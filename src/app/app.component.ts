...
export class AppComponent {
    ...
    public logo: string = 'blue-grey';//light,dark,indigo,blue-grey
        ...
        router.events.subscribe((val) => {
            if (val instanceof NavigationStart) {
                ...
                if (data.length == 1) {
                    ...
                    console.log('data-controller:' + data[0]);
                    console.log('data-view:' + data[1]);
                    ...
                    console.log('default controller service view management');
                    self['controller'] = 'service';
                    self['view'] = 'management';
                    $('body').attr('data-controller', 'service');
                    $('body').attr('data-view', 'management');
                }
